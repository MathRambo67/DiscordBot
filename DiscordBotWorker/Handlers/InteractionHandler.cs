...
internal class InteractionHandler : HandlerBase
{
    private readonly IServiceProvider _provider;
    private readonly InteractionService _interactionService;
    private readonly IHostEnvironment _environment;

    public InteractionHandler(DiscordSocketClient client, IConfiguration config, ILogger<DiscordClientService> logger, IServiceProvider provider, InteractionService interactionService, IHostEnvironment environment, IConfiguration configuration) : base(client, logger, config)
    {
        _provider = provider;
